...
from architecture.infrastructure.src.components.db.qdrant.manager import QdrantManager
from architecture.infrastructure.src.components.conversational.memory.chat_history import ChatHistory

chathistory = ChatHistory()
from architecture.infrastructure.src.components.embeddings.embedding import Embedding 
...
from architecture.infrastructure.src.components.advanced.query_transformation.query_normalization import QueryNormalization   
...
from architecture.infrastructure.src.components.advanced.query_transformation.query_classification import QueryClassification
query_classifier = QueryClassification(
    model=model,
    api_key=api_key
)

from architecture.infrastructure.src.components.advanced.query_transformation.query_general import QueryGeneral
query_general = QueryGeneral(
    model=model,
    api_key=api_key
)

from architecture.infrastructure.src.components.advanced.query_routing.logical_routing import LogicalRouting
